      ...
      >
        <div
          className={cn(
            ...
            "shadow-[inset_0_0_1px_1px_hsl(var(--border)/0.3)] dark:shadow-none",
            "sm:shadow-[inset_0_0_2px_1px_hsl(var(--border)/0.3)] dark:sm:shadow-none",
            "ring-1 ring-border/50 dark:ring-gray-800",
        ...
        >
          ...
          <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 sm:p-1.5 md:p-2 shadow-md dark:shadow-none">
            <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white dark:bg-[#1a1a1a] p-2 sm:p-3 md:p-4 shadow-xl dark:shadow-none ring-1 ring-border/50">
